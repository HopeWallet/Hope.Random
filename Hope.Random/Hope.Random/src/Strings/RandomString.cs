...
using System;
using Hope.Random.Strings.Abstract;
using FastRandom = System.Random;

namespace Hope.Random.Strings
{
    /// <summary>
    ...
    public static class RandomString
    {
        ...
        public static class Secure
        {
            ...
            /// </summary>
            public sealed class Blake2 : SecureRandomStringBase<Blake2bDigest> { }
            ...
            /// </summary>
            public sealed class MD5 : SecureRandomStringBase<MD5Digest> { }
            ...
            /// </summary>
            public sealed class RIPEMD256 : SecureRandomStringBase<RipeMD256Digest> { }
            ...
            /// This is considered not as secure as the SHA family of hash functions, while it is still often used for PGP encryption.
            /// </summary>
            public sealed class RIPEMD320 : SecureRandomStringBase<RipeMD320Digest> { }
            ...
            /// </summary>
            public sealed class SHA1 : SecureRandomStringBase<Sha1Digest> { }
            ...
            /// </summary>
            public sealed class SHA3 : SecureRandomStringBase<Sha3Digest> { }
            ...
            /// </summary>
            public sealed class SHA256 : SecureRandomStringBase<Sha256Digest> { }
            ...
            /// This is considered a moderately secure hash algorithm. While it has yet to be broken, <see cref="SHA3"/> offers higher level of security.
            /// </summary>
            public sealed class SHA512 : SecureRandomStringBase<Sha512Digest> { }
            ...
            /// This is considered a very secure hash algorithm as it is a subset of the Keccak family of hashing functions.
            /// </summary>
            public sealed class Shake : SecureRandomStringBase<ShakeDigest> { }
            ...
            /// </summary>
            public sealed class SM3 : SecureRandomStringBase<SM3Digest> { }
            ...
            /// </summary>
            public sealed class Tiger : SecureRandomStringBase<TigerDigest> { }
            ...
            /// </summary>
            public sealed class Whirlpool : SecureRandomStringBase<WhirlpoolDigest> { }
        }
