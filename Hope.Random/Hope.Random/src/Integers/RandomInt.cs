...
using Hope.Random.Integers.Abstract;
using FastRandom = System.Random;

namespace Hope.Random.Integers
{
    /// <summary>
    ...
    public static class RandomInt
    {
        ...
        public static class Secure
        {
            ...
            /// </summary>
            public sealed class Blake2 : SecureRandomIntBase<Blake2bDigest> { }
            ...
            /// </summary>
            public sealed class MD5 : SecureRandomIntBase<MD5Digest> { }
            ...
            /// </summary>
            public sealed class RIPEMD256 : SecureRandomIntBase<RipeMD256Digest> { }
            ...
            /// This is considered not as secure as the SHA family of hash functions, while it is still often used for PGP encryption.
            /// </summary>
            public sealed class RIPEMD320 : SecureRandomIntBase<RipeMD320Digest> { }
            ...
            /// </summary>
            public sealed class SHA1 : SecureRandomIntBase<Sha1Digest> { }
            ...
            /// </summary>
            public sealed class SHA3 : SecureRandomIntBase<Sha3Digest> { }
            ...
            /// </summary>
            public sealed class SHA256 : SecureRandomIntBase<Sha256Digest> { }
            ...
            /// This is considered a moderately secure hash algorithm. While it has yet to be broken, <see cref="SHA3"/> offers higher level of security.
            /// </summary>
            public sealed class SHA512 : SecureRandomIntBase<Sha512Digest> { }
            ...
            /// This is considered a very secure hash algorithm as it is a subset of the Keccak family of hashing functions.
            /// </summary>
            public sealed class Shake : SecureRandomIntBase<ShakeDigest> { }
            ...
            /// </summary>
            public sealed class SM3 : SecureRandomIntBase<SM3Digest> { }
            ...
            /// </summary>
            public sealed class Tiger : SecureRandomIntBase<TigerDigest> { }
